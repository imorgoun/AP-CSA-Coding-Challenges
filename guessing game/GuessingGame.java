...
public class GuessingGame {
    ...
    public static void newGame() {
        ...
        int currentGuess = 102; int chosenInt = random.nextInt(100)+1; int numberOfGuesses = 0;
        ...
        System.out.println("Do you want to play again?"); input.nextLine(); answerContinue = input.nextLine();
        for (int i = 0; i < answersYes.length; i++) {if (answersYes[i].equals(answerContinue)) {newGame();}}
        System.out.println("Overall results:"); System.out.println("Total games     = " + numberOfGames);
        System.out.println("Total guesses   = "+totalGuesses);
        System.out.println("Guesses/game    = "+totalGuesses/numberOfGames);
